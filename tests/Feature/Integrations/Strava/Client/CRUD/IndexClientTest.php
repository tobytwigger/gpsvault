...
class IndexClientTest extends TestCase
{
    ...
    public function assertPaginatesClients(Collection $models, string $responseAttribute)
    {
        $this->get(route('strava.client.index', [
            ...
            ->has($responseAttribute . 'Clients', fn (Assert $page) => $page
                ->has('data', 5)
    ...
    public function it_can_paginate_through_all_at_the_same_time(){
        ...
        $this->get(route('strava.client.index', [
            ...
            ->component('Integrations/Strava/Client/Index')
            ->has('ownedClients', fn (Assert $page) => $page
                ->has('data', 5)
            ...
            ->has('sharedClients', fn (Assert $page) => $page
                ->has('data', 4)
            ...
            ->has('publicClients', fn (Assert $page) => $page
                ->has('data', 3)
    ...
    public function you_must_be_authenticated(){
        $response = $this->get(route('strava.client.index'));
