    ...
    computed: {
        duplicateMessage() {
            if(this.duplicateActivity !== null) {
                return 'This activity is a duplicate of ' + this.ziggyRoute('activity.show', this.duplicateActivity.id) + '. You can still upload it if you would like.';
            }
            return null;
        }
    },
    methods: {
        checkForDuplicateActivity() {
            ...
            reader.addEventListener('load',function (event) {
                ...
                axios.post(this.ziggyRoute('activity.file.duplicate'), {hash: hash})
