    ...
    computed: {
        duplicateMessage() {
            if(this.duplicateRoute !== null) {
                return 'This route is a duplicate of ' + this.ziggyRoute('route.show', this.duplicateRoute.id) + '. You can still upload it if you would like.';
            }
            return null;
        }
    },
    methods: {
        checkForDuplicateRoute() {
            ...
            reader.addEventListener('load',function (event) {
                ...
                axios.post(this.ziggyRoute('route.file.duplicate'), {hash: hash})
